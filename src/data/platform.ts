...
export const resources: Resource[] = [
  { id: "r1", title: "Sustainability Reporting Foundations", type: "course", provider: "Coursera", description: "Free intro course on GRI/SASB/ISSB frameworks.", careerPaths: ["esg-reporting"], cost: "free" },
  { id: "r2", title: "Project Drawdown", type: "guide", provider: "Drawdown", description: "Comprehensive guide to climate solutions ranked by impact.", careerPaths: ["climate-policy", "renewable-energy"], cost: "free" },
  { id: "r3", title: "Outrage + Optimism", type: "podcast", provider: "Global Optimism", description: "Leading climate podcast hosted by Christiana Figueres.", careerPaths: ["climate-policy", "climate-communications"], cost: "free" },
  { id: "r4", title: "Climate Change Coffee Talk", type: "podcast", provider: "Independent", description: "Bite-sized climate science and policy explainers.", careerPaths: ["climate-communications", "climate-education"], cost: "free" },
  { id: "r5", title: "Doughnut Economics", type: "book", provider: "Kate Raworth", description: "Reframing economics for sustainability.", careerPaths: ["circular-economy", "climate-policy"], cost: "paid" },
  { id: "r6", title: "Drawdown (Book)", type: "book", provider: "Paul Hawken", description: "100 solutions to reverse global warming.", careerPaths: ["climate-policy", "renewable-energy", "circular-economy"], cost: "paid" },
  { id: "r7", title: "Cradle to Cradle", type: "book", provider: "McDonough & Braungart", description: "Foundational circular economy text.", careerPaths: ["circular-economy"], cost: "paid" },
  { id: "r8", title: "Terra.do Climate Change Learning for Action", type: "fellowship", provider: "Terra.do", description: "12-week climate change fellowship for career switchers.", careerPaths: ["climate-policy", "renewable-energy", "esg-reporting"], cost: "paid" },
  { id: "r9", title: "On Deck Climate Tech", type: "fellowship", provider: "On Deck", description: "Community-based climate tech fellowship.", careerPaths: ["renewable-energy", "sustainability-data"], cost: "paid" },
  { id: "r10", title: "Work on Climate Slack", type: "community", provider: "Work on Climate", description: "Active community for climate career switchers.", careerPaths: ["climate-policy", "renewable-energy", "esg-reporting"], cost: "free" },
  { id: "r11", title: "ClimateBase Jobs", type: "community", provider: "ClimateBase", description: "Largest climate jobs board and community.", careerPaths: ["climate-policy", "renewable-energy", "sustainability-data"], cost: "free" },
  { id: "r12", title: "GHG Protocol Standards", type: "guide", provider: "WRI", description: "Authoritative GHG accounting standards and guidance.", careerPaths: ["esg-reporting", "sustainable-supply-chain", "sustainability-data"], cost: "free" },
  { id: "r13", title: "IPCC AR6 Synthesis Report", type: "guide", provider: "IPCC", description: "The definitive climate science synthesis.", careerPaths: ["climate-policy", "climate-communications", "climate-education"], cost: "free" },
  { id: "r14", title: "MyClimate Carbon Markets 101", type: "article", provider: "MyClimate", description: "Beginner-friendly guide to voluntary carbon markets.", careerPaths: ["carbon-markets"], cost: "free" },
  { id: "r15", title: "How to Save a Planet", type: "podcast", provider: "Spotify", description: "Solutions-focused climate podcast.", careerPaths: ["climate-communications", "climate-education"], cost: "free" },
  { id: "r16", title: "Power BI for Sustainability Dashboards", type: "course", provider: "Udemy", description: "Build ESG and emissions dashboards in Power BI.", careerPaths: ["sustainability-data", "esg-reporting"], cost: "paid" },
  { id: "r17", title: "Ellen MacArthur Foundation Learning Hub", type: "course", provider: "EMF", description: "Free courses on circular economy across industries.", careerPaths: ["circular-economy", "sustainable-supply-chain", "sustainable-fashion"], cost: "free" },
  { id: "r18", title: "Nature Positive Initiative", type: "guide", provider: "Nature Positive", description: "Standards and guidance for nature-positive business.", careerPaths: ["biodiversity-conservation"], cost: "free" },
];
