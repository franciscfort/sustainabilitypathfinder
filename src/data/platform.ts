...
export const certifications: Certification[] = [
  ...
  { id: "pmi-cspp", name: "PMI Construction Sustainability & Practices (CSPP) Bundle", provider: "PMI", level: "intermediate", cost: "paid", costNote: "exam + course bundle", timeCommitment: "30-40 hours", description: "PMI credential covering sustainable practices in construction and infrastructure projects.", careerPaths: ["programs-project-management", "green-building", "sustainable-supply-chain"], url: "https://www.pmi.org/certifications/cspp-bundle-exam-course" },
  { id: "oecd-rbc-academy", name: "OECD e-Learning Academy on Responsible Business Conduct", provider: "OECD", level: "intermediate", cost: "free", timeCommitment: "10-15 hours", description: "Official OECD training on due diligence and responsible business conduct across supply chains.", careerPaths: ["sustainable-supply-chain", "esg-reporting", "environmental-consulting", "climate-policy"], url: "https://www.oecd.org/en/topics/sub-issues/due-diligence-guidance-for-responsible-business-conduct/oecd-e-learning-academy-on-responsible-business-conduct.html" },
  { id: "informea-env-governance", name: "Introduction to Environmental Governance", provider: "InforMEA / UNEP", level: "beginner", cost: "free", timeCommitment: "8 hours", description: "UN course on multilateral environmental agreements and how environmental governance works.", careerPaths: ["climate-policy", "biodiversity-conservation", "environmental-consulting"], url: "https://elearning.informea.org/course/info.php?id=33" },
  { id: "unccl-net-zero-101", name: "Net Zero 101: What, Why and How", provider: "UN CC:Learn", level: "beginner", cost: "free", timeCommitment: "4-6 hours", description: "Free UN certified course explaining net zero targets and how organisations deliver them.", careerPaths: ["esg-reporting", "carbon-markets", "climate-policy"], url: "https://unccelearn.org/course/view.php?id=185&lang=en&page=overview" },
  { id: "unccl-sustainable-finance", name: "Introduction to Sustainable Finance", provider: "UN CC:Learn", level: "beginner", cost: "free", timeCommitment: "6 hours", description: "Free UN certified introduction to green bonds, climate finance and sustainable investment.", careerPaths: ["carbon-markets", "esg-reporting", "grant-writing-mobilization"], url: "https://unccelearn.org/course/view.php?id=139&lang=en&page=overview" },
  { id: "unccl-green-fiscal", name: "Green Fiscal Policy", provider: "UN CC:Learn", level: "intermediate", cost: "free", timeCommitment: "8 hours", description: "Free UN certified course on carbon pricing, subsidy reform and green budgeting.", careerPaths: ["climate-policy", "carbon-markets"], url: "https://unccelearn.org/course/view.php?id=112&lang=en&page=overview" },
];
...
export const resources: Resource[] = [
  ...
  // --- Additional verified UN & OECD courses ---
  { id: "r86", title: "Net Zero 101: What, Why and How", type: "course", provider: "UN CC:Learn", description: "Free UN course on what net zero means and how organisations set and deliver credible targets.", careerPaths: ["esg-reporting", "carbon-markets", "climate-policy"], cost: "free", url: "https://unccelearn.org/course/view.php?id=185&lang=en&page=overview" },
  { id: "r87", title: "Introduction to Sustainable Finance", type: "course", provider: "UN CC:Learn", description: "Free UN introduction to green bonds, climate finance instruments and sustainable investing.", careerPaths: ["carbon-markets", "esg-reporting", "grant-writing-mobilization"], cost: "free", url: "https://unccelearn.org/course/view.php?id=139&lang=en&page=overview" },
  { id: "r88", title: "Plastic Waste and the Basel Convention", type: "course", provider: "UN CC:Learn", description: "Free UN course on global plastic waste rules, trade controls and circular solutions.", careerPaths: ["circular-economy", "sustainable-supply-chain", "environmental-consulting"], cost: "free", url: "https://unccelearn.org/course/view.php?id=131&lang=en&page=overview" },
  { id: "r89", title: "Gender Equality and Human Rights in Climate Action and Renewable Energy", type: "course", provider: "UN CC:Learn", description: "Free UN course on integrating gender equality and human rights into climate and energy work.", careerPaths: ["climate-policy", "renewable-energy", "community-sustainability", "programs-project-management"], cost: "free", url: "https://unccelearn.org/course/view.php?id=142&lang=en&page=overview" },
  { id: "r90", title: "Green Fiscal Policy", type: "course", provider: "UN CC:Learn", description: "Free UN course on carbon pricing, fossil fuel subsidy reform and green budgeting.", careerPaths: ["climate-policy", "carbon-markets"], cost: "free", url: "https://unccelearn.org/course/view.php?id=112&lang=en&page=overview" },
  { id: "r91", title: "Advancing Sustainable Development in Practice", type: "course", provider: "UN CC:Learn", description: "Free UN course on turning the SDGs into practical programmes and projects.", careerPaths: ["programs-project-management", "community-sustainability", "education-capacity-building", "research-knowledge-management"], cost: "free", url: "https://unccelearn.org/course/view.php?id=181&lang=en&page=overview" },
  { id: "r92", title: "OECD e-Learning Academy on Responsible Business Conduct", type: "course", provider: "OECD", description: "Official OECD training on supply chain due diligence and responsible business conduct.", careerPaths: ["sustainable-supply-chain", "esg-reporting", "environmental-consulting", "climate-policy"], cost: "free", url: "https://www.oecd.org/en/topics/sub-issues/due-diligence-guidance-for-responsible-business-conduct/oecd-e-learning-academy-on-responsible-business-conduct.html" },
  { id: "r93", title: "Introduction to Environmental Governance", type: "course", provider: "InforMEA / UNEP", description: "Free UN course on multilateral environmental agreements and environmental governance.", careerPaths: ["climate-policy", "biodiversity-conservation", "environmental-consulting"], cost: "free", url: "https://elearning.informea.org/course/info.php?id=33" },
  { id: "r94", title: "Anticipatory Governance: Systems Thinking & Strategic Foresight for SDG-Aligned Integrated Planning", type: "course", provider: "UNITAR", description: "Free UN course on systems thinking and strategic foresight for SDG-aligned planning.", careerPaths: ["climate-policy", "programs-project-management", "research-knowledge-management"], cost: "free", url: "https://www.unsdglearn.org/courses/anticipatory-governance-systems-thinking-strategic-foresight-for-sdg-aligned-integrated-planning/" },
  { id: "r95", title: "Inclusive Learning Design", type: "course", provider: "UNITAR", description: "Free UN course on designing learning experiences that include every learner.", careerPaths: ["education-capacity-building", "climate-education"], cost: "free", url: "https://www.unsdglearn.org/courses/inclusive-learning-design/" },
  { id: "r96", title: "Practical Methods to Implement and Uphold the FPOS for Producers", type: "course", provider: "UNITAR", description: "Free UN course on applying the Fundamental Principles of Official Statistics in data production.", careerPaths: ["research-knowledge-management", "sustainable-supply-chain"], cost: "free", url: "https://statistics.unsdglearn.org/courses/practical-methods-to-implement-and-uphold-the-fpos-for-producers/" },
  { id: "r97", title: "Introduction to Official Statistics", type: "course", provider: "UNITAR", description: "Free UN introduction to official statistics and how they underpin evidence-based decisions.", careerPaths: ["research-knowledge-management", "sustainability-data", "esg-reporting"], cost: "free", url: "https://statistics.unsdglearn.org/courses/introduction-to-official-statistics/" },
  { id: "r98", title: "Insurance and the Sustainable Development Goals", type: "course", provider: "UNITAR", description: "Free UN course on how insurance and risk financing support the SDGs and climate resilience.", careerPaths: ["climate-finance", "esg-reporting"], cost: "free", url: "https://www.unsdglearn.org/courses/insurance-and-the-sustainable-development-goals/" },
  { id: "r99", title: "Developing Skills for Women Leadership in Climate Action", type: "course", provider: "UNITAR", description: "Free UN course building negotiation, communication and leadership skills for women climate leaders.", careerPaths: ["climate-policy", "community-sustainability", "partnerships-stakeholder-engagement"], cost: "free", url: "https://www.unsdglearn.org/courses/developing-skills-for-women-leadership-in-climate-action/" },
  { id: "r100", title: "Strengthening Stakeholder Engagement for the Implementation and Review of the 2030 Agenda", type: "course", provider: "UNITAR", description: "Free UN course on designing inclusive stakeholder engagement for SDG delivery and review.", careerPaths: ["partnerships-stakeholder-engagement", "programs-project-management", "community-sustainability"], cost: "free", url: "https://www.unsdglearn.org/courses/strengthening-stakeholder-engagement-for-the-implementation-and-review-of-the-2030-agenda/" },
  { id: "r101", title: "Introduction to Sports for Climate Action", type: "course", provider: "UNITAR", description: "Free UN course on how the sports sector can cut emissions and mobilise climate action.", careerPaths: ["climate-communications", "climate-education", "community-sustainability"], cost: "free", url: "https://www.unsdglearn.org/courses/introduction-to-sports-for-climate-action/" },
  { id: "r102", title: "SDG-aligned Budgeting", type: "course", provider: "UNITAR", description: "Free UN course on aligning public budgets and spending with the SDGs.", careerPaths: ["climate-policy", "climate-finance", "grant-writing-mobilization"], cost: "free", url: "https://www.unsdglearn.org/courses/sdg-aligned-budgeting/" },
  { id: "r103", title: "Geospatial Information Technology in Fragile Contexts", type: "course", provider: "UNITAR", description: "Free UN course on using satellite imagery and GIS in fragile and crisis settings.", careerPaths: ["sustainability-data", "biodiversity-conservation", "research-knowledge-management"], cost: "free", url: "https://www.unsdglearn.org/courses/geospatial-information-technology-in-fragile-contexts/" },
  { id: "r104", title: "Mainstreaming the 2030 Agenda for Sustainable Development", type: "course", provider: "UNITAR", description: "Free UN course on embedding the SDGs in national plans, policies and institutions.", careerPaths: ["climate-policy", "programs-project-management", "education-capacity-building"], cost: "free", url: "https://www.unsdglearn.org/courses/mainstreaming-the-2030-agenda-for-sustainable-development/" },
  { id: "r105", title: "Art and the Stewardship of the Ocean", type: "course", provider: "UNITAR", description: "Free UN course exploring ocean stewardship through art, culture and creative advocacy.", careerPaths: ["climate-communications", "climate-education", "water-ocean"], cost: "free", url: "https://www.unsdglearn.org/courses/art-and-the-stewardship-of-the-ocean/" },
  { id: "r106", title: "Infrastructure Asset Management for Sustainable Development", type: "course", provider: "UNITAR", description: "Free UN course on managing infrastructure assets sustainably across their lifecycle.", careerPaths: ["programs-project-management", "renewable-energy", "green-building"], cost: "free", url: "https://www.unsdglearn.org/courses/infrastructure-asset-management-for-sustainable-development/" },
  { id: "r107", title: "Mastering International Climate Negotiations: All You Need to Know", type: "course", provider: "UNITAR", description: "Free UN course on the UNFCCC process, COP negotiations and climate diplomacy.", careerPaths: ["climate-policy", "partnerships-stakeholder-engagement"], cost: "free", url: "https://www.unsdglearn.org/courses/mastering-international-climate-negotiations-all-you-need-to-know/" },
  { id: "r108", title: "Environmental SDG Indicators", type: "course", provider: "UNITAR", description: "Free UN course on measuring environmental progress with SDG indicators and data.", careerPaths: ["esg-reporting", "research-knowledge-management", "sustainability-data"], cost: "free", url: "https://www.unsdglearn.org/courses/environmental-sdg-indicators/" },
  { id: "r109", title: "Fundamental Principles of Official Statistics (FPOS) and their Relevance for Policymakers", type: "course", provider: "UNITAR", description: "Free UN course on why trustworthy official statistics matter for policymaking.", careerPaths: ["climate-policy", "research-knowledge-management"], cost: "free", url: "https://statistics.unsdglearn.org/courses/fundamental-principles-of-official-statistics-fpos-and-their-relevance-for-policymakers/" },
  { id: "r110", title: "Strengthening Climate Adaptation and Resilience", type: "course", provider: "UNITAR", description: "Free UN course on planning and delivering climate adaptation and resilience programmes.", careerPaths: ["climate-policy", "community-sustainability", "biodiversity-conservation"], cost: "free", url: "https://www.unsdglearn.org/courses/strengthening-climate-adaptation-and-resilience/" },
  { id: "r111", title: "Understanding Data and Statistics Better — for More Effective SDG Decision Making", type: "course", provider: "UNITAR", description: "Free UN course on interpreting data and statistics for smarter SDG decisions.", careerPaths: ["sustainability-data", "esg-reporting", "research-knowledge-management"], cost: "free", url: "https://www.unsdglearn.org/courses/understanding-data-and-statistics-better-for-more-effective-sdg-decision-making/" },
];
